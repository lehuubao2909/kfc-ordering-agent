...
/**
 * Tóm tắt đơn — data từ DB (order + menu qua service, KHÔNG mock).
 * Giá dòng: ưu tiên unitPriceVnd snapshot lúc đặt (OrderLine); thiếu → giá menu hiện tại.
 */
export function OrderSummary({ order, menu, compact = false }: { order: Order; menu: MenuItem[]; compact?: boolean }) {
